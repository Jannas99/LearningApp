...
class KarooList2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Todo 1
        val iterator = mBirdlist!!.slice(setOf(200 ,201 ,212 ,218 ,219 ,222 ,238 ,260 ,296 ,297 ,298 ,309 ,310 ,313 ,314 ,326 ,327 ,334 ,338 ,339 ,340 ,341 ,345 ,350 ,367 ,374 ,381 ,389 ,391 ,429)).iterator()
        ...
        binding?.btnSave?.setOnClickListener {
            QuestionsSetter.instance?.addRecordKaroo(birdDao)
        }
