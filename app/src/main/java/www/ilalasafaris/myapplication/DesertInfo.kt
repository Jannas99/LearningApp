...
import www.ilalasafaris.myapplication.databinding.ActivityDesertInfoBinding
import www.ilalasafaris.myapplication.databinding.SpecieslListBinding

class DesertInfo : AppCompatActivity() {
    lateinit var binding: ActivityDesertInfoBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDesertInfoBinding.inflate(layoutInflater)
        ...
        binding.tobasicliststart.setOnClickListener{
            val intent = Intent(this, DesertStart::class.java)
    ...
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@DesertInfo, object : OnBackPressedCallback(true) {
