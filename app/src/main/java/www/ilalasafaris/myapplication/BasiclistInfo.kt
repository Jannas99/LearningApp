...
import www.ilalasafaris.myapplication.databinding.ActivityBasicinfoBinding
import www.ilalasafaris.myapplication.databinding.SpecieslListBinding


class BasiclistInfo : AppCompatActivity() {
    lateinit var binding: ActivityBasicinfoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tobasicliststart.setOnClickListener{
            val intent = Intent(this, BasicStart::class.java)
    ...
    private fun initActionBar() {
        ...
        actionbar!!.setTitle("Beginner List")
        actionbar.setDisplayHomeAsUpEnabled(true)
        actionbar.setHomeButtonEnabled(true)
    }
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@BasiclistInfo, object : OnBackPressedCallback(true) {
