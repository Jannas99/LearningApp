...
class SavannaWestCreate : AppCompatActivity() {
    ...
    private fun adaptorSearchSaveData() {
        ...
        aabirdname.setOnItemClickListener(object :AdaptorCreate.OnItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                lifecycleScope.launch {
                    birdDao.insert_SavannaWest(SavannaWestStart.Data(idbird = idbird, name = name,sname= sname, picture1 = picture1, picture2 = picture2, picture3 = picture3, picture4 = picture4, picture5 = picture5,  sound = sounds))
                }
    ...
    private fun iflistisnotfull(birdList: ArrayList<SavannaWestStart.Data>) {
        ...
        binding?.manageList?.setOnClickListener {
            if (birdList.isNotEmpty()) {
                val intent = Intent(this, SavannaWestManage::class.java)
                startActivity(intent)
                MyMediaPlayer.instance!!.onBack()
                finish()
            } else {
    ...
    private fun initActionBar() {
        ...
        actionbar!!.title = "Create List Western Savanna"
