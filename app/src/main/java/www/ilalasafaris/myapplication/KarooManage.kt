...
class KarooManage : AppCompatActivity() {
    private var binding: ActivityManageBinding? = null
    private var lBirdlist:ArrayList<KarooStart.Data> = ArrayList()
    ...
    private fun setupListofDataIntoRecyclerView(birdlist: ArrayList<KarooStart.Data>, birdDao: DaoBirds) {
    ...
    private fun deleteBird(deleteId: Int,birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.fetchBirdById_Karoo(deleteId).collect {
    ...
    private fun deleteRecord(id: Int, birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.delete_Karoo(KarooStart.Data(id))
        }
    ...
    private fun initActionBar() {
        ...
        actionbar!!.title = "Manage List Karoo"
    ...
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@KarooManage, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                val intent = Intent(this@KarooManage, CoreCreate::class.java)
