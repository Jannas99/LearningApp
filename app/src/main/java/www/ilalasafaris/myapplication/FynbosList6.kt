...
class FynbosList6 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Todo 1
        val iterator = mBirdlist!!.slice(setOf(517 ,519 ,521 ,523 ,524 ,527 ,530 ,531 ,539 ,543 ,544 ,546 ,547 ,549 ,551 ,554 ,557 ,559 ,562 ,564 ,568 ,572 ,574 ,576 ,580 ,583 ,585 ,586 ,588 ,590)).iterator()
