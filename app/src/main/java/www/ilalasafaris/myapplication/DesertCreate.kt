...
class DesertCreate : AppCompatActivity() {
    ...
    private fun adaptorSearchSaveData() {
        ...
        aabirdname.setOnItemClickListener(object :AdaptorCreate.OnItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                lifecycleScope.launch {
                    birdDao.insert_Desert(DesertStart.Data(idbird = idbird, name = name,sname= sname, picture1 = picture1, picture2 = picture2, picture3 = picture3, picture4 = picture4, picture5 = picture5,  sound = sounds))
                }
