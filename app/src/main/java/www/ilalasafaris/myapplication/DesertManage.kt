...
class DesertManage : AppCompatActivity() {
    private var binding: ActivityManageBinding? = null
    private var lBirdlist:ArrayList<DesertStart.Data> = ArrayList()
    ...
    private fun setupListofDataIntoRecyclerView(birdlist: ArrayList<DesertStart.Data>, birdDao: DaoBirds) {
    ...
    private fun deleteBird(deleteId: Int,birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.fetchBirdById_Desert(deleteId).collect {
    ...
    private fun deleteRecord(id: Int, birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.delete_Desert(DesertStart.Data(id))
        }
    ...
    private fun initActionBar() {
        ...
        actionbar!!.title = "Manage List Desert"
    ...
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@DesertManage, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                val intent = Intent(this@DesertManage, CoreCreate::class.java)
