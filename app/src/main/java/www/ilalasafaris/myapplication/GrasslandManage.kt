...
class GrasslandManage : AppCompatActivity() {
    private var binding: ActivityManageBinding? = null
    private var lBirdlist:ArrayList<GrasslandStart.Data> = ArrayList()
    ...
    private fun setupListofDataIntoRecyclerView(birdlist: ArrayList<GrasslandStart.Data>, birdDao: DaoBirds) {
    ...
    private fun deleteBird(deleteId: Int,birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.fetchBirdById_Grassland(deleteId).collect {
    ...
    private fun deleteRecord(id: Int, birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.delete_Grassland(GrasslandStart.Data(id))
        }
    ...
    private fun initActionBar() {
        ...
        actionbar!!.title = "Manage List Grassland"
    ...
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@GrasslandManage, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                val intent = Intent(this@GrasslandManage, CoreCreate::class.java)
