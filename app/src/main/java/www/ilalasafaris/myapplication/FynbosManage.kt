...
class FynbosManage : AppCompatActivity() {
    private var binding: ActivityManageBinding? = null
    private var lBirdlist:ArrayList<FynbosStart.Data> = ArrayList()
    ...
    private fun setupListofDataIntoRecyclerView(birdlist: ArrayList<FynbosStart.Data>, birdDao: DaoBirds) {
    ...
    private fun deleteBird(deleteId: Int,birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.fetchBirdById_Fynbos(deleteId).collect {
    ...
    private fun deleteRecord(id: Int, birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.delete_Fynbos(FynbosStart.Data(id))
        }
    ...
    private fun initActionBar() {
        ...
        actionbar!!.title = "Manage List Fynbos"
    ...
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@FynbosManage, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                val intent = Intent(this@FynbosManage, CoreCreate::class.java)
