...
class BuilderManage : AppCompatActivity() {
    ...
    private fun setupListofDataIntoRecyclerView(birdlist: ArrayList<MainActivity.Data>, birdDao: DaoBirds) {
    ...
    private fun deleteBird(deleteId: Int,birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.fetchBirdById_Personal1(deleteId).collect {
    ...
    private fun deleteRecord(id: Int, birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.delete_Personal1(MainActivity.Data(id))
        }
