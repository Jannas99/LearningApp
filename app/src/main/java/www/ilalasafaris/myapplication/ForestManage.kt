...
class ForestManage : AppCompatActivity() {
    ...
    private fun setupListofDataIntoRecyclerView(birdlist: ArrayList<ForestStart.Data>, birdDao: DaoBirds) {
    ...
    private fun deleteBird(deleteId: Int,birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.fetchBirdById_Forest(deleteId).collect {
    ...
    private fun deleteRecord(id: Int, birdDao: DaoBirds) {
        lifecycleScope.launch {
            birdDao.delete_Forest(ForestStart.Data(id))
        }
    ...
    private fun initActionBar() {
        ...
        actionbar!!.title = "Manage List Forest"
    ...
    private fun setupOnBackPressedCallback() {
        onBackPressedDispatcher.addCallback(this@ForestManage, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                val intent = Intent(this@ForestManage, CoreCreate::class.java)
