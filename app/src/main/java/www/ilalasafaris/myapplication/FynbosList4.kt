...
class FynbosList4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Todo 1
        val iterator = mBirdlist!!.slice(setOf(268 ,269 ,272 ,273 ,274 ,276 ,298 ,300 ,301 ,304 ,306 ,310 ,311 ,318 ,320 ,322 ,325 ,329 ,330 ,341 ,346 ,353 ,359 ,360 ,361 ,362 ,363 ,365 ,366 ,367  )).iterator()
